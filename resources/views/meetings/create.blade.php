<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('messages.create_new_meeting') }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="{{ route('meetings.store') }}">
                        ...
                        <div class="mt-4">
                            <x-input-label for="scheduled_at" :value="__('messages.scheduled_at')" />
                        ...
                        <!-- Attendees -->
                        <div class="mt-4">
                            <x-input-label for="attendees" :value="__('messages.attendees')" />
                            ...
                            <small class="text-gray-500 dark:text-gray-400">{{ __('messages.multiple_attendees') }}</small>
                        </div>
